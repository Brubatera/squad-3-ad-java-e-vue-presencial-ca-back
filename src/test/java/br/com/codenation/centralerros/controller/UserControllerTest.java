package br.com.codenation.centralerros.controller;//package br.com.codenation.centralerros.controller;
...
public class UserControllerTest {
    ...
    @Test
    public void deveretornarUmaListaDeUser() {
        List<User> logSources = new ArrayList<>();
        for (int i = 0; i < 2; i++) {
            logSources.add(buildUser(null));
        }
        Mockito.when(userController.findAll()).thenReturn(logSources);
